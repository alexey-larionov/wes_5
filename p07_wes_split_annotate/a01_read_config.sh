...
kgen_sites_vcf=$(get_parameter "kgen_sites_vcf") # e.g. ALL.wgs.phase3_shapeit2_mvncall_integrated_v5a.20130502.sites.fixed.split.vcf
...
exac_sites_vcf=$(get_parameter "exac_sites_vcf") # e.g. ExAC_nonTCGA.r0.3.1.sites.vep.filt.split.vcf.gz
